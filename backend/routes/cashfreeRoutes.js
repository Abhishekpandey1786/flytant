...
const planDetails = {
  Basic: { amount: 3, maxApplications: 6 },
  Standard: { amount: 5, maxApplications: 15 },
  Advance: { amount: 9, maxApplications: 40 },
  Premium: { amount: 19, maxApplications: 9999 },
};
const updateSubscription = async (userId, planName) => {
  ...
  const updateData = {
    ...
    "subscription.applications_made_this_month": 0,
    "subscription.last_reset_date": new Date(),
  };
