                                    ...
                                    <div className="bg-slate-900 border border-fuchsia-500 rounded-xl p-4 shadow-[0_0_20px_rgba(217,70,239,0.5)] w-full">
                                      <div className="flex flex-col items-center text-center">
                                        ...
                                        <div className="w-full border-t border-slate-700 pt-3 flex justify-around">
                                         <a href={applicant.user.instagram} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()}>
                                            <FaInstagram className="text-pink-500 text-xl" />
                                            <span className="text-[10px] text-fuchsia-300 font-bold underline italic">Visit</span>
                                          </a>
                                          <a href={applicant.user.facebook} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()}>
                                            <FaFacebook className="text-blue-500 text-xl" />
                                            <span className="text-[10px] text-fuchsia-300 font-bold underline italic">Visit</span>
                                          </a>
                                          <a href={applicant.user.youtube} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()}>
