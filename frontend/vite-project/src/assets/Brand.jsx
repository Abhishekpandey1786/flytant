...
import img4 from "./image/brand1.png";
import img5 from "./image/brand2.png";
import img6 from "./image/brand3.png";
      ...
      >
        ...
        <nav className="flex-1 w-full">
          <ul className="space-y-3">
            {[
              { name: "Home", key: "home", icon: <FiHome className="text-xl animate-pulse  text-fuchsia-400" /> },
              { name: "Campaigns", key: "Campaigns", icon: <FiTrendingUp className="text-xl animate-pulse  text-fuchsia-400" /> },
              { name: "Brands", key: "brands", icon: <FiTag className="text-xl animate-pulse  text-fuchsia-400" /> },
              ...
              { name: "News", key: "News", icon: <FiFileText className="text-xl animate-pulse  text-fuchsia-400" /> },
            ].map((item) => (
              <li
                key={item.key}
