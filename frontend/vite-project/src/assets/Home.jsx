    ...
    <div className="min-h-screen bg-slate-800 text-white font-inter overflow-hidden flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center pt-24 md:pt-32 pb-8 md:pb-12 px-4 md:px-16">
        <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center gap-8 md:gap-10">
          ...
          <div className="flex-1 relative">
            {/* Optimization: fetchpriority for LCP & Dimensions for CLS */}
            <img
              src={img1}
              width="480"
              height="438"
              fetchpriority="high"
              alt="Vistafluence Influencer Marketing Dashboard"
      ...
      <section className="bg-slate-900 py-16 px-4 md:px-16 text-center">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-3xl md:text-4xl font-bold mb-6">What is vistafluence.com?</h3>
          <p className="text-gray-200 text-lg md:text-xl leading-relaxed">
            vistafluence.com is a dynamic platform that connects brands with the right influencers and helps influencers find brand deals that align with their passion.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-16 bg-slate-800 text-center">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="flex flex-col items-center p-6 bg-slate-700 rounded-xl shadow-lg neno-button shadow-x1 hover:shadow-fuchsia-800/50 transition">
            <span className="text-5xl mb-4" role="img" aria-label="Rocket">🚀</span>
            <h4 className="text-xl font-bold mb-2">1. Sign Up & Build Your Profile</h4>
            <p className="text-gray-200 text-sm">Choose your role (Influencer or Brand) and create your profile. Tell us about your interests.</p>
          </div>
          <div className="flex flex-col items-center p-6 bg-slate-700 rounded-xl shadow-lg neno-button shadow-x1 hover:shadow-fuchsia-800/50 transition">
            <span className="text-5xl mb-4" role="img" aria-label="Magnifying Glass">🔍</span>
            <h4 className="text-xl font-bold mb-2">2. Find Your Partner</h4>
            <p className="text-gray-200 text-sm">Influencers can discover campaigns, and brands can find the perfect influencer easily.</p>
          </div>
          <div className="flex flex-col items-center p-6 bg-slate-700 rounded-xl shadow-lg neno-button shadow-x1 hover:shadow-fuchsia-800/50 transition">
            <span className="text-5xl mb-4" role="img" aria-label="Handshake">🤝</span>
            <h4 className="text-xl font-bold mb-2">3. Collaborate & Succeed</h4>
            <p className="text-gray-200 text-sm">Finalize deals, create content, and track your performance together.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
          <div className="flex-1 lg:order-2">
            ...
            <p className="text-gray-200 text-lg mb-6">
              Turn your passion into profit! Connect with brands that fit your audience perfectly.
            </p>
            ...
            <Link to="/signup?role=influencer" aria-label="Join as an Influencer">
              <button className="neno-button shadow-x1 hover:shadow-fuchsia-800/50 text-white border-2 hover:bg-fuchsia-800 border-fuchsia-800 rounded-4xl py-2 md:py-4 px-4 md:px-8 text-sm md:text-base uppercase relative overflow-hidden">
          ...
          <div className="flex-1 lg:order-1 relative">
            <img
              ...
              height="518"
              loading="lazy"
              alt="Influencer collaborating on campaigns"
      ...
      <section className="py-16 px-4 md:px-16 bg-slate-800">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
          <div className="flex-1">
            ...
            <p className="text-gray-200 text-lg mb-6">
              Boost your brand recognition by connecting with the right influencers.
            </p>
            <ul className="text-gray-100 text-base space-y-3 mb-6 list-disc list-inside text-left">
              <li>Discover influencers for your target audience.</li>
              <li>Create and manage impactful campaigns.</li>
              <li>Track your performance in real-time.</li>
            </ul>
            <Link to="/signup?role=advertiser" aria-label="Join as a Brand">
              <button className="neno-button shadow-x1 hover:shadow-fuchsia-800/50 text-white border-2 hover:bg-fuchsia-800 border-fuchsia-800 rounded-4xl py-2 md:py-4 px-4 md:px-8 text-sm md:text-base uppercase relative overflow-hidden">
                Join as a Brand
              </button>
            </Link>
          ...
          <div className="flex-1 relative">
            <img
              ...
              height="518"
              loading="lazy"
              alt="Brand managing marketing analytics"
              className="rounded-2xl shadow-xl w-full object-cover transition-transform duration-300 hover:scale-105"
            />
          </div>
        </div>
      ...
      <section className="bg-slate-900 py-16 px-4 md:px-16 text-center">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-slate-800 p-8 rounded-xl shadow-lg text-left">
            <p className="text-lg italic mb-4 text-gray-200">"vistafluence.com has made working with brands incredibly easy. My earnings have grown significantly."</p>
            <p className="font-bold">- Priya, Fashion Influencer</p>
          </div>
          <div className="bg-slate-800 p-8 rounded-xl shadow-lg text-left">
            <p className="text-lg italic mb-4 text-gray-200">"We found the right influencers which reduced our costs and increased sales."</p>
      ...
      <section className="bg-slate-800 py-16 px-4 md:px-16 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-100 text-lg md:text-xl mb-8">
            Whether you're a brand or an influencer, get the tools you need for success.
          </p>
          <Link to="/signup">
